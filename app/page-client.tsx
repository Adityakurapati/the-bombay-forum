...
const EDITORS_PICKS = [
  {
    ...
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDZMHNmqSexwU7PV2iMKlX7tA4ZTZAvPWp1iOg7StFmefOEnwefF9KT7_yMzhO3HLR8chtOghYOf6jsEocY076-k8xyxI2u-Y2_0euzY-EhrA81fMgYSU7cwVXvLf0f0uZS4uV9AzO7o1WviMLhte_bSm0uyrF3OXno9WjY-8_Eo7X_iD68m2hdKAcDscMZRmpNW3pwbSng88HH1esvNy43r1_20YTLT6yhdeIE_-y4UzAJVMBzrj_o93YW54xJz60ry7WrlDqu0E7Q',
  },
  {
    href: '/categories/future',
    section: 'The Exchange',
    title: "Decoding the SaaS Correction: A Founder's Survival Guide.",
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDzfkR7XHVKEzhpxjzCcDy1AuwpIdME8YaWsS33K64SYOFa9OGjtP0W8F5huAyl5VR9aCYG9pFGBuHwfSMZiM7W-3-rWTaavCFtBUrSupm-Mtvgy8dD9N2JsvEMtGl3SSVlyl1NEvDM3KORfhyKQpDYkLKAb7iPfudO2c_mCKBI_tFApGaJNWSv5f95Gj8dwujom8GLpjquvdw2756ze7Leev2-diwBDQgU8XkEsr0XWl217p6tAda4YfyoomfJqsgWFUYRX6IA-jc8',
  },
  {
    href: '/categories/future',
    section: 'Future',
    title: "Ladakh's New Sovereign: The Rise of Ultra-Luxe Glamping.",
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDkUQG1ap0LIWsOI2U4mlCKdXZrW80P5L6vOF3jF_MWeMFI6u0jr9qJS8HlynmAf8ZB5q3HAcTJkehrBEqM5EcY6OyotBNU6qfepfpjoh1Y3ZuT0cfsRsEDxt-IiL9s9ytFWlbjAt9mRmDv8hjkR8aEmjLSVOIah55Vybb-G-u2XQ-hmgtejfTc74IPejYRHdCc3kW0zfKUIw5Tst7mhIxU-r6JRBZl0bngqLuVjo71YdxUQKCCKSemzOsVScw0SGjlecOWLHkZUsf-',
  },
];

const FEATURED_WEEK = [
  {
    href: '/categories/bombay',
    section: 'Bombay',
    title: "The Bean Economy: Why Specialty Coffee is India's New Gold.",
    excerpt: 'How local roasteries are challenging global giants with terroir-driven narratives and aggressive retail footprints.',
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCUV91hU8blW_K9rfM8xyav_O0knO-wjsrppIV_UX2cDEcOeH0N2V6rlcM8ZHqrE6J0Bc_y_BcuRyjrchaLlIhAXRVg53sfVNjyyTdy8nu1gjJ0BhnnXVEe1DqhnelwLRi6BSCaujueRZqSRwIDxH54MqPS3RQ5LGsNhnNR6GPiSzmQQPB2T_JRE9zZ0bq2FNR_wlu8UnwOQMcjo11cDuLxSzylE0CHfReZF-IfCVKnq7oABiCCGFIKzNVc6XQL4u8DWNZTYciieWTx',
  },
  {
    href: '/categories/creators',
    section: 'Creators',
    title: 'Investing in the Avant-Garde: A Guide to the Contemporary Indian Art Market.',
    excerpt: 'Beyond the masters—identifying the next generation of visual storytellers before they hit the auction blocks.',
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuARxhVwPnqHyrvNOeR48JqVhjWp2fglzmL8K27Lek679JyKOnuAY9oDzkJXfd3joyuMTdyO82QStGKCgLwwaaFdm3Rc9BzwwrVuQcmgnJ66BDesKLYQQeSeBPIMT0W5WXip6VujtYvWel6YfN8pVTfiK9bIDuPiSxUyQR9_fU6TtNgprcAvRhz2jt5j_GIJ64vFa3OGYb5y2sFifPXIZIFvnTS7tOMQao8SBlC9b3Xs-KHSCwxPPVzznX5hthTvnMBScak4eeyk5yWN',
  },
  {
    href: '/categories/future',
    section: 'Future',
    title: "Quiet Power: The Silent Revolution of India's Premium EV Segment.",
    excerpt: "Inside the bespoke workshops building the electric future for India's 0.1%.",
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBP5SksybXJ5UAHvCElnAsPX9jYvUFrYS3Dp2yPxc2HjiK6xGYmMoNQxyF7uBgGuAWbWQUJ7oUpGD18KWeCgD-EFEkAcABIpxOIcKY1AKUoaHNzKnnjTvN50pAyZg_Lj_FVUb1s-zv2uqE3mPOZWqWld1E_-9xaHjd5AqoiXk2K9SXK78Urw5_SJXXqLN75FCsMS8bsnt6NOlqinZXw_AQmu6D0qq318YUSPY0eB4cN1mVckUhfIEu3e7FayErp7IYFVHjtADZJV3xQ',
  },
];
...
const SUITE_ITEMS = [
  {
    ...
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuD5ZMaS3NmrMCHZgNYbhHlnCcdUpeCjLXU98BNaq4-4pcAWdfT97bHTWajifDoShNDm97kfDXscbZ9S-wzhjFFfRutp8bUWMod-ei7Rk60kc8J265KHwc9rSNo6paGjNNe7E2jxvz5LisU4ihApBg4AQng_Jcn8FMnhWqPTMSl4s7LUhwWa90doWaAabV62ZQXhUrdz_1gtxB5ABALo5MPoU5Fa9uz3Pia_Y6AddSIOddX5sXRW7V4nU8VmKls-E0iRf8clgr_yzeRJ',
  },
  {
    section: 'Bombay',
    title: 'Masque Mumbai: 10 Courses of Modern Alchemy.',
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuChZ8Kzbs68upW7JrZmrSsabWB7UewJbMDK051Woid2Mq1ZkXrD2tzQCAjmyT0g66Coj7gyaewC4Q1qAf9ded3LR3RxMi2FnxNEu_7P0Li9WwkR1BvNcr5rrSKRsp2he9eecNp6d_R4fzGwSC8MS5_zA0Cg8pod_lRVTtNe2IR1A8LZS3mMiB7-tEIVAlNUPWAT8x16tpBKujpuAUY_SFlcrphbPZvCwzn3c4iVQ7ACBcjUMRTj2n0_PNO--QPOB2SitRduoIADXW3_',
  },
  {
    section: 'The Suite',
    title: "The Hidden Estate: Goa's Most Private Sanctuary.",
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAidG40_w8YMSKZTqrV5m43c3lL2T9tWxhgCn2DkdD4VkUvuQNhSLiQvg9NDhLF6Xzg3yydAPzMNtrgc7TFiZaRmJyb26w3WzhffC4IaYct44bnDkMRUfLsMOhKc5sPagB51qKEX2PMziwZFTGWsqccYsyQbRfjQAE6dYJqI5GAawaCaakrXDGXiE2oOPIPwuM0PEOuagS_yTwz1DBf6DglUP5D6eV5-UYbTGM2vOgHxsbIcytpgRY0Xs7HED2Hq901GcJWYgVr2Upl',
  },
];
...
export default function HomePageClient() {
  ...
  return (
    <div className="font-body text-on-surface selection:bg-accent-teal selection:text-white" style={{ backgroundColor: '#F8F8F4' }}>
      ...
      <main className="max-w-[1440px] mx-auto px-8 pt-16">
          ...
          <article className="lg:w-[65%] group cursor-pointer">
            ...
            <div>
              ...
              <p className="text-xl text-on-surface-variant max-w-2xl font-body leading-relaxed opacity-80">
                How a fresh wave of operators-turned-investors is dismantling the traditional Bombay club and rewriting the rules of Series A capital.
              </p>
        ...
        <section className="mb-32">
          <div className="flex justify-between items-end mb-16 border-b border-outline-variant/30 pb-6">
            ...
            <Link
              href="/categories/founders"
              className="text-[10px] uppercase tracking-widest font-bold border-b-2 border-accent-teal pb-1 hover:text-accent-teal transition-colors font-label"
            >
              View All Stories
            </Link>
          </div>
        ...
        {/* ── 3. THE FOUNDERS MAGAZINE SPREAD ── */}
        <section className="mb-32 flex flex-col lg:flex-row gap-20 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-12 max-w-sm shadow-2xl hidden lg:block border-l-8 border-accent-teal">
                <p className="font-headline text-2xl italic text-primary mb-6">
                  "The next decade of global innovation won't happen in Silicon Valley. It's happening in the streets of Bengaluru and the boardrooms of Mumbai."
                </p>
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-8 text-on-surface-variant leading-relaxed text-lg font-body">
              <p>
                For the last decade, growth-at-all-costs was the North Star. Founders were celebrated for burning cash in pursuit of market share. Today, the tide has turned.
              </p>
              <p>
                In this deep-dive, we talk to the architects of India's most resilient unicorns who have pivoted from vanity metrics to sustainable unit economics. We explore the internal cultural shifts, the harsh budget cuts, and the eventual liberation that comes with being a 'default alive' business.
              </p>
            </div>
            <Link
              href="/categories/founders"
      ...
      {/* ── 4. SPONSORED STRIP ── */}
      <section
        className="py-14 px-8 mb-32 overflow-hidden relative"
        style={{ backgroundColor: '#11262B' }}
      >
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <Link
            href="/spotlight"
            className="text-white border px-10 py-3 text-[10px] uppercase tracking-[0.3em] hover:bg-accent-teal transition-all font-label"
            style={{ borderColor: 'rgba(139,176,184,0.4)' }}
          >
      ...
      <section className="max-w-[1440px] mx-auto px-8 mb-32">
        ...
        <div
          className="flex gap-10 overflow-x-auto pb-10"
      ...
      {/* ── 6. NEWSLETTER ── */}
      <section
        className="py-32 px-8 text-center border-y border-outline-variant/20 mb-0"
        style={{ backgroundColor: 'rgba(214,233,228,0.3)' }}
      >
        <div className="max-w-2xl mx-auto">
          ...
          <form
            ...
            className="flex flex-col sm:flex-row gap-0 border-b-2 border-primary"
          >
            <input
              type="email"
              value={email}
          ...
          <p
            className="mt-8 text-[9px] uppercase tracking-[0.4em] font-bold italic font-label"
            style={{ color: 'rgba(139,176,184,0.6)' }}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24 max-w-[1440px] mx-auto">
          ...
          <div className="flex flex-col gap-5">
            ...
            {['The Founders', 'Creators', 'The Exchange', 'Future', 'The Suite'].map((l) => (
              <Link key={l} href={NAV_HREFS[l] ?? '#'} className="text-slate-300 hover:text-white transition-colors text-sm font-body">
                {l}
              </Link>
            ))}
          </div>
