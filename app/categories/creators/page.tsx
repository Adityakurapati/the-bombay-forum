        ...
        <section className="py-24 px-12" style={{ backgroundColor: '#F5F5F0' }}>
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="aspect-[4/5] overflow-hidden">
              <img
                className="w-full h-full object-cover"
                alt="Distinguished Indian filmmaker in minimal studio"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAadXP028Z4z8ceVZjd1HSKIK4vXHFw0bNC_TfiVYPxtpqnvaxbqe82lH7Z3ws3AZ1tubkkAEumlqRWQKi1XPu8uKaHlps-ptV_jI7S8soJCQzFtDU71NgvWkDBbZxYu6VEeasQulM8Ez5NXubddyFs6krFG2OS9-ncsbMBH47tfzkiHDTDIWv2cmAhoQOyCI-Z2EG51H5dVEB4UoCIWGWLf4WPivDATl6AoPVQD2fNhtXl4ugShXSMSMTGHgjqu8qsPnTJSQmVC_"
              />
            </div>
            <div className="flex flex-col items-start">
              ...
              <h2 className="font-headline text-5xl mb-2">Devansh Malhotra</h2>
              ...
              <div className="border-l-4 border-brand-teal pl-8 mb-8">
                <blockquote className="font-headline text-2xl text-brand-navy leading-relaxed italic">
                  "Bombay isn't just a city; it's a living, breathing storyboard that demands to be
                  told through a lens of raw, unpolished truth."
                </blockquote>
              </div>
              <p className="font-body text-on-surface/70 leading-relaxed mb-8 max-w-md">
                With three international awards under his belt, Malhotra is redefining the aesthetic
                of independent cinema in India. His latest feature explores the silent rhythms of the
                Dharavi artisan community.
              </p>
              <Link
                href="/creators/aryan-varma"
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-16 gap-x-12">
              {contentGrid.map((item) => (
                <article key={item.title} className="group flex flex-col cursor-pointer">
                  ...
                  <span className="text-on-surface/40 text-[10px] font-medium tracking-wide font-label">
                    {item.read}
                  </span>
                </article>
              ))}
