...
const sideItems = [
  { sub: 'AI & ETHICS', title: 'The Digital Dharma: Coding Ethics into Silicon.', body: 'How ancient philosophical frameworks are finding new life in neural network alignment.' },
  { sub: 'MOBILITY', title: 'Beyond the Battery: The Hydrogen Leap.', body: "Why India's logistics backbone is skipping the EV revolution for a cleaner alternative." },
  { sub: 'SPACE ECONOMY', title: 'Low Orbit, High Stakes.', body: "The private players redefining India's commercial presence in the cosmos." },
  { sub: 'FUTURE OF WORK', title: 'The Post-Office Paradigm.', body: 'Exploring the rise of decentralized autonomous organizations in the Indian tech sector.' },
];

const signalCards = [
  { title: 'Vertical Farming in Tier-2 Cities', body: 'Localized food security is outperforming centralized logistics in cost-efficiency metrics.', signal: true },
  { title: 'Metaverse Real Estate Hype', body: 'Capital flows are pivoting back to physical infrastructure as virtual land value cools.', signal: false },
  { title: 'Programmable Biology Hubs', body: "Bengaluru's pivot to bio-manufacturing is mirroring the software boom of the 90s.", signal: true },
  { title: 'Decentralized Power Grids', body: 'Solar-microgrids are finally decoupling rural prosperity from the main grid.', signal: true },
];

const storyGrid = [
  { sub: 'BIOTECH', title: 'The Longevity Dividend.', body: 'How Indian labs are tackling the genetic markers of metabolic aging.', read: '8 min read', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAzhYBj4CFKFUydM25qNvpIEuT8gLau5E4-14AWt3Jvv3MHGzjTdsrDC_NWZuEiZwIT3tc2OeKYyQZuFhWS5bGWqoGMRHJxQJtYRjab_b5CUz9hoXRjiMfEs1YX2wWytiDsGD8IHoSJL1jXzM9WvtDdhRlgZloY-W98LmsKJv4vXp_VyRKqO4H206iyI1TMQRQiLh8VeifpyWdnF53wmtyJzqZWFzLm_3uAW2-CDTIWzD6d04BKmFeCXiHQNRoiQmmN7gjqoszoDtA9' },
        ...
        <section className="bg-surface-container-lowest py-24 px-12">
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="lg:w-3/5 group cursor-pointer">
              <div className="aspect-[16/10] overflow-hidden mb-8">
                <img
                  ...
                  alt="Neural networks merging with Indian mandala patterns"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuDQ8VomQSVjynppc7Q_7mDwN_dpLcgOM_QBTWJBdXbL9zk7ZNaE5MOWxAW304LITOHoQoxQHXhg_p3LyxAzw02gbJTk-txBj7ORNI7uJWmP6bi_QacVN0UKvrSFKtQzIB4sz7EPRC6eWImhzicgO5XGac0jxTKGLDQxtlwy1zyHvUasHwRZCD2wq6x48VkRJL6F6wJbkf4Hxs8VU5zG2g46RnyeFew41oqldPEWp_l3BH77aFPTR6U034v16Rc6siltnMemKbSncJW5"
                />
              </div>
              ...
              <p className="font-body text-lg text-secondary mb-8 max-w-2xl leading-relaxed">
                As the global race for artificial general intelligence accelerates, India is carving out
                a unique strategy that prioritizes sovereign data over raw compute power.
              </p>
              <Link href="#" className="font-label font-bold flex items-center gap-2 group/link" style={{ color: TEAL }}>
                Read the Essay
            ...
            <div className="lg:w-2/5 flex flex-col">
              {sideItems.map((item) => (
                <div key={item.title} className="flex flex-col border-t border-outline-variant/30 py-6 group cursor-pointer">
                  <span className="font-label uppercase tracking-widest text-[10px] font-bold mb-2" style={{ color: TEAL }}>
                    {item.sub}
                  </span>
                  <h3 className="font-headline text-2xl font-bold mb-2 transition-colors" style={{}} >
                    {item.title}
                  </h3>
        ...
        <section className="py-32 px-12 text-center overflow-hidden relative" style={{ backgroundColor: '#0B1929' }}>
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <p className="font-label uppercase tracking-[0.3em] text-sm text-white/60 mb-8">
              — ROHINI RAO, PRINCIPAL AT AKASH VENTURES
            </p>
            <Link href="#" className="font-label font-bold flex items-center justify-center gap-2 group/link" style={{ color: TEAL }}>
              Read the Full Essay
              <span className="transition-transform duration-300 group-hover/link:translate-x-2">→</span>
            </Link>
          </div>
